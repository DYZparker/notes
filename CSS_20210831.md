...
我们知道，HTML、CSS和JavaScript是前端技术中最核心的三个元素。HTML控制网页的结构，CSS控制网页的外观，而JavaScript控制网页的行为。
...
text-decoration属性来定义字体下划线、删除线和顶划线。
...
text-transform属性来转换文本的大小写，这个是针对英文而言，因为中文不存在大小写之分。
...
text-align属性控制文本的水平方向的对齐方式：左对齐、居中对齐、右对齐。只能针对文本文字和<img>标签，对其他标签无效。
